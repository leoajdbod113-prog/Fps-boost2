-- NEXUS V20 GOD MODE + AUTO BLOCK FIX
...
Backup = {}
BackupCreated = false
OriginalStreamingRadius, OriginalStreamingMinRadius
...
SoundsBtn, SoundsState = CreateExtraToggle("DESLIGAR SONS", 208, SoundsOff)
