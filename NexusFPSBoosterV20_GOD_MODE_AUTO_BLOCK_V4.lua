...
function NexusV4_SetBlockOutput(active)
	-- This is the only execution boundary.
	-- In the user's own arena, define _G.NexusV4_SetBlock(active)
	-- to call the game's legitimate block controller.
	local fn = rawget(_G, 'NexusV4_SetBlock')
