...
NexusEmotes = {
	["Mirror World"] = { Emote = "dance",  Color = Color3.fromRGB(170, 90, 255), Secondary = Color3.fromRGB(60, 0, 120) },
	["Prop Hunt"]    = { Emote = "point",  Color = Color3.fromRGB(255, 220, 0), Secondary = Color3.fromRGB(255, 120, 0) },
	["Crane"]        = { Emote = "dance2", Color = Color3.fromRGB(70, 170, 255), Secondary = Color3.fromRGB(180, 235, 255) },
	["Boxer"]        = { Emote = "dance3", Color = Color3.fromRGB(255, 210, 40), Secondary = Color3.fromRGB(255, 110, 0) },
	["Tiger"]        = { Emote = "cheer",  Color = Color3.fromRGB(255, 60, 80), Secondary = Color3.fromRGB(255, 150, 0) },
	["Snake"]        = { Emote = "laugh",  Color = Color3.fromRGB(70, 255, 100), Secondary = Color3.fromRGB(0, 130, 70) },
	["Thunder"]      = { Emote = "cheer",  Color = Color3.fromRGB(40, 235, 255), Secondary = Color3.fromRGB(120, 245, 255) },
	["Omega Flowery"]= { Emote = "wave",   Color = Color3.fromRGB(255, 225, 90), Secondary = Color3.fromRGB(255, 130, 220) },
}
...
local function NexusEmoteStop()
	local _, humanoid = NexusEmoteCharacter()
	if humanoid then
		pcall(function()
...
local function NexusEmotePlay(name)
	...
	local ok, result = pcall(function()
		return humanoid:PlayEmote(cfg.Emote)
	end)
