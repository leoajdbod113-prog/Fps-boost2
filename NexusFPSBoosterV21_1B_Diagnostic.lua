...
local function createDiagnosticUI()
    ...
    local old = playerGui:FindFirstChild("NexusV21_1B_Diagnostic")
    if old then
        old:Destroy()
    end

    local gui = Instance.new("ScreenGui")
    gui.Name = "NexusV21_1B_Diagnostic"
...
_G.NEXUS_V21_1B_DIAGNOSTIC = NEXUS_DIAG
_G.NEXUS_V21_1B_DISABLE_SPEED = true
_G.NEXUS_V21_1B_DISABLE_FLY = true
...
pcall(function()
    ...
    local diag = _G.NEXUS_V21_1B_DIAGNOSTIC
