-- NexusFPSBooster V21.2-Diagnostic
...
local function createDiagnosticUI()
    ...
    local old = playerGui:FindFirstChild("NexusV21_2_Diagnostic")
    if old then
        old:Destroy()
    end

    local gui = Instance.new("ScreenGui")
    gui.Name = "NexusV21_2_Diagnostic"
...
if SavedConfig then
	...
	SpeedEnabled = false -- V21.2 diagnostic: forced OFF
	...
	FlyEnabled = false -- V21.2 diagnostic: forced OFF
...
FlyButton.MouseButton1Click:Connect(function()
	FlyEnabled = false -- V21.2 diagnostic: locked OFF
	if FlyEnabled then
...
SpeedToggle.MouseButton1Click:Connect(function()
	SpeedEnabled = false -- V21.2 diagnostic: locked OFF
	SpeedToggle.Text = SpeedEnabled and "ON" or "OFF"
	SpeedToggle.TextColor3 = SpeedEnabled and GREEN or RED
	SpeedToggle.BackgroundColor3 = SpeedEnabled and Color3.fromRGB(15, 45, 30) or PANEL2
	SpeedStatus.Text = SpeedEnabled and "●  SPEED ACTIVE" or "●  SPEED DISABLED"
...
if not __V212BodyOK then
    NEXUS_DIAG.failed = true
    NEXUS_DIAG.ui.error("V21.2 BODY | " .. __V212_STAGE, __V212BodyErr)
    console("V21.2 BODY ERROR | STAGE=" .. __V212_STAGE .. " | " .. safeString(__V212BodyErr))
    NEXUS_DIAG.ui.status("ERROR / " .. __V212_STAGE)
else
    NEXUS_DIAG.ui.log("[NEXUS] V21 BODY END")
    NEXUS_DIAG.ui.status("READY / V21 BODY END")
    console("V21.2 BODY END")
end
